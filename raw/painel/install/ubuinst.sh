...
echo -e "PLAY CONECT" | figlet | boxes -d stone -p a0v0 | lolcat
echo "SE VOCÊ NÃO PUDER SE DESTACAR PELO TALENTO, VENÇA PELO ESFORÇO."| lolcat
echo -e " \033[1;33m[\033[1;31m########################################\033[1;33m] - \033[1;32m100%\033[0m"| lolcat
echo ""
echo ""
echo -e "                       \033[05;31mSISTEMAS \033[05;33mOPERACIONAIS\033[0m"| lolcat
echo ""
echo -e "\033[1;31• \033[1;33mUBUNTU 18 x64\033[0m "| lolcat
echo -e "\033[1;31• \033[1;33mUBUNTU 20 x64\033[0m "| lolcat
echo -e "\033[1;31• \033[1;33mDEBIAN  9 x64\033[0m "| lolcat
echo -e "\033[1;31• \033[1;33mDEBIAN 10 x64\033[0m "| lolcat
echo -e "\033[1;31• \033[1;33mDEBIAN 11 x64\033[0m "| lolcat
echo -e "\033[1;31m \033[1;33m\033[0m"
echo -e "\033[1;31• \033[1;33mUSE UBUNTU 18 x64 PARA UMA MELHOR EXPERIÊNCIA\033[0m"| lolcat
echo -e "\033[1;31• \033[1;33mUSE UBUNTU 18 x64 PARA (V2RAY) EVITEM OUTROS SISTEMAS\033[0m"| lolcat
echo -e "\033[1;31m \033[1;33m\033[0m"| lolcat
echo ""
echo -e " \033[1;33m[\033[1;31m########################################\033[1;33m] - \033[1;32m100%\033[0m"| lolcat
echo ""
echo -ne "\033[1;36mTECLE ENTER PARA CONTINUAR\033[1;37m "| lolcat; read _key_
function msg {
